...
int main(){
	...
	address string = s.allocate(sizeof("Hello World!\n"));
	...
	string = s.allocate(sizeof("smol"));
	s.write("smol", string, sizeof("smol"));
	s.printHeap();

	address string2 = s.allocate(sizeof("tiny"));
	s.write("tiny", string2, sizeof("tiny"));
	s.printHeap();

	s.free(string);
	s.free(string2);
	
	string = s.allocate(sizeof("Hello World!\n"));
	s.write("Hello World!\n", string, sizeof("Hello World!\n"));
	s.printHeap();
